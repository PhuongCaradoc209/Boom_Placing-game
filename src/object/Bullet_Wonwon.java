...
public class Bullet_Wonwon extends Projectile {
    private BufferedImage up5, down5, right5, left5;
    GamePanel gp;
    public Bullet_Wonwon(GamePanel gp) {
        super(gp);
        this.gp = gp;
        size = gp.tileSize - 30;
...
//        left5 = setup("projectile/slime/bullet_slime_5_left", 44, 32);
        ...
        up1 = setup("projectile/wonwon/wonwon_up_1", 32, 32);
        up2 = setup("projectile/wonwon/wonwon_up_2", 32, 32);

        right1 = setup("projectile/wonwon/wonwon_right_1", 32, 32);
        right2 = setup("projectile/wonwon/wonwon_right_2", 32, 32);

        left1 = setup("projectile/wonwon/wonwon_left_1", 32, 32);
        left2 = setup("projectile/wonwon/wonwon_left_2", 32, 32);

        down1 = setup("projectile/wonwon/wonwon_down_1", 32, 32);
        down2 = setup("projectile/wonwon/wonwon_down_2", 32, 32);
    }
